...
struct Post: Identifiable {
    ...
    static var DataVideo = [
        ...
        Post(author: Author.AllAcount[0], FhotoAuthor: Author.AllAcount[0], player: AVPlayer (url: URL(fileURLWithPath: Bundle.main.path(forResource: "IMG_7187", ofType: "MOV")!)), replay: false),
        Post(author: Author.AllAcount[0], FhotoAuthor: Author.AllAcount[0], player: AVPlayer (url: URL(fileURLWithPath: Bundle.main.path(forResource: "IMG_7847", ofType: "MOV")!)), replay: false),
        Post(author: Author.AllAcount[0], FhotoAuthor: Author.AllAcount[0], player: AVPlayer (url: URL(fileURLWithPath: Bundle.main.path(forResource: "IMG_7847", ofType: "MOV")!)), replay: false),
